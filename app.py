...
from models import db, connect_to_database, Cupcake
...
def list_cupcakes():
    ...
    cupcakes = [cupcake.make_Dictionary() for cupcake in Cupcake.query.all()]
...
def create_cupcake():
    ...
    return (jsonify(cupcake=cupcake.make_Dictionary()), 201)
